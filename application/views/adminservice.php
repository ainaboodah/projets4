                                        ...
                                        <table class="account-table table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>AB123CD</td>
                                                    <td>$20</td>
                                                    <td><button class="btn btn-primary">editer</button><button class="btn btn-primary">Supprimer</button></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                            ...
                            <div class="custom-block custom-block-balance">
                                ...
                                <form action="" name="insertservice">
                                    <div>
                                        ...
                                        <input class="form-control" type="Text" name="profile-name" id="profile-name">
                                        <p>Total</p>
                                        <input class="form-control" type="Number" name="profile-email" id="profile-email">
